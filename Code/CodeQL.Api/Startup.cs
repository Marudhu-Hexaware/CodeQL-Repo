using CodeQL.Api.Installer;
using CodeQL.Api.Middleware;
using CodeQL.Data.Repositories;
...
namespace CodeQL.Api
{
    public class Startup
    {
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            ...
            app.UseSwaggerUI(c =>
            {
                c.SwaggerEndpoint("/swagger/v1/swagger.json", "CodeQL V1");
            });
